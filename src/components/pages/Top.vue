...
import SymbolText from '../parts/SymbolText.vue'
</script>
  ...
  <div class="top">
    <div class="card">
      <div class="card__thumbnail">
        <img
          src="https://source.unsplash.com/r1XwWjI4PyE"
          class="card__thumbnailImage"
          alt="Cereals Image"
        />
      </div>
      <div class="card__detail">
        <h3 class="card__title">ポラーノの広場</h3>
